        ...
        <div class="row">
            <div class="col-lg-4 col-12 location-item">
                ...
                <div class="location-description">
                    ...
                    <p class="location-description">Sexta, 22 de Fevereiro</p>
                </div>
            </div>
            <div class="col-lg-4 col-12 location-item">
                <div class="location-icon">                
                    <img src="<?php bloginfo("template_url");?>/img/icone-mapa.png" alt="Oxigênio Aceleradora" class="location-icon" />
                </div>
                <div class="location-description">
                    <h3 class="location-title">Onde?</h3>
                    <p class="location-description">Oxigênio Aceleradora - São Paulo, SP!</p>
                </div>
            </div>
            <div class="col-lg-4 col-12 location-item">
                <div class="location-icon">
                ...
                <div class="location-description">
                    ...
                    <p class="location-description">A partir das 18h</p>
                </div>
            </div>
        </div>
    </div>
